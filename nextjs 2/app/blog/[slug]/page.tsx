...
export default function BlogPostPage({ params }: { params: { slug: string } }) {
  ...
  const ld = { "@context": "https://schema.org", "@type": "BlogPosting", headline: post.title, description: post.metaDescription, datePublished: post.publishedAt, dateModified: post.publishedAt, author: { "@type": "Organization", name: "Ottr Plumr Plumbing & Heating", url: "https://plumr.ca" }, publisher: { "@type": "Organization", name: "Ottr Plumr Plumbing & Heating", logo: { "@type": "ImageObject", url: "https://plumr.ca/assets/ottr-plumr-logo.webp" } }, mainEntityOfPage: { "@type": "WebPage", "@id": `https://plumr.ca/blog/${post.slug}` } };
  return (
