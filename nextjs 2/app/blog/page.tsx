...
const ld = { "@context": "https://schema.org", "@type": "Blog", name: "Ottr Plumr — Niagara Plumbing & Heating Blog", url: "https://plumr.ca/blog", blogPost: POSTS.map((p) => ({ "@type": "BlogPosting", headline: p.title, url: `https://plumr.ca/blog/${p.slug}`, datePublished: p.publishedAt, author: { "@type": "Organization", name: "Ottr Plumr Plumbing & Heating" } })) };
